...
\lstinputlisting[language=python,firstline=1, lastline=89]{vandermonde.py}
...
\noindent
This is the code used for this exercise:
\lstinputlisting[language=python, firstline=93, lastline=195]{vandermonde.py}
...
\noindent
This is the code used for this exercise:
\lstinputlisting[language=python, firstline=196, lastline=277]{vandermonde.py}
...
\lstinputlisting[language=python, firstline=280]{vandermonde.py}